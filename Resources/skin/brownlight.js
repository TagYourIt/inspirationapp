var skin = {
    ...
    "POST_BAR_COLOR"      : "#833028", // example: #ff840a

    // about tab bar color and image
    // if use image, bar color and title should empty
    // if use text title, bar image should empty
    "ABOUT_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "ABOUT_BAR_COLOR"     : "#833028", // example: #ff840a

    "WEBVIEW_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "WEBVIEW_BAR_COLOR"   : "#833028", // example: #ff840a
    
    "TWITTER_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "TWITTER_BAR_COLOR"   : "#833028", // example: #ff840a
    
    "PAGES_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "PAGES_BAR_COLOR"     : "#833028", // example: #ff840a

    // table view for recent news
    "RECENT_TV_BGCOLOR"    : "#faebca",   
    "RECENT_TV_BGCOLOR_ALT": "#faebca",   
    "RECENT_TV_SEPARATOR_COLOR": "#fff",   
    "RECENT_TV_TITLE_COLOR": "#55503d",   
    "RECENT_TV_META_COLOR" : "#835023",  

    // table view for categories 
    "CATEG_TV_BGCOLOR"    : "#faebca",   
    "CATEG_TV_BGCOLOR_ALT": "#faebca",   
    "CATEG_TV_SEPARATOR_COLOR": "#fff",   
    "CATEG_TV_TITLE_COLOR": "#55503d",   
    "CATEG_TV_META_COLOR" : "#835023",  
    
    // table view for twitter 
    "TWITTER_TV_BGCOLOR"    : "#faebca",   
    "TWITTER_TV_BGCOLOR_ALT": "#faebca",   
    "TWITTER_TV_SEPARATOR_COLOR": "#fff",   
    "TWITTER_TV_TITLE_COLOR": "#55503d",   
    "TWITTER_TV_META_COLOR" : "#835023", 
    
    // table view for pages 
    "PAGES_TV_BGCOLOR"    : "#faebca",   
    "PAGES_TV_BGCOLOR_ALT": "#faebca",   
    "PAGES_TV_TITLE_COLOR": "#55503d", 
