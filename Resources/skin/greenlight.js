var skin = {
    ...
    "POST_BAR_COLOR"      : "#5f812c", // example: #ff840a

    // about tab bar color and image
    // if use image, bar color and title should empty
    // if use text title, bar image should empty
    "ABOUT_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "ABOUT_BAR_COLOR"     : "#5f812c", // example: #ff840a

    "WEBVIEW_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "WEBVIEW_BAR_COLOR"   : "#5f812c", // example: #ff840a
    
    "TWITTER_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "TWITTER_BAR_COLOR"   : "#5f812c", // example: #ff840a
    
    "PAGES_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "PAGES_BAR_COLOR"     : "#5f812c", // example: #ff840a

    // table view for recent news
    "RECENT_TV_BGCOLOR"    : "",   
    "RECENT_TV_BGCOLOR_ALT": "",   
    "RECENT_TV_SEPARATOR_COLOR": "#c1cbae",   
    "RECENT_TV_TITLE_COLOR": "#3a3b34",   
    "RECENT_TV_META_COLOR" : "#5a5b56",  

    // table view for categories 
    "CATEG_TV_BGCOLOR"    : "",   
    "CATEG_TV_BGCOLOR_ALT": "",   
    "CATEG_TV_SEPARATOR_COLOR": "#c1cbae",   
    "CATEG_TV_TITLE_COLOR": "#3a3b34",   
    "CATEG_TV_META_COLOR" : "#5a5b56",  
    
    // table view for twitter 
    "TWITTER_TV_BGCOLOR"    : "",   
    "TWITTER_TV_BGCOLOR_ALT": "",   
    "TWITTER_TV_SEPARATOR_COLOR": "#c1cbae",   
    "TWITTER_TV_TITLE_COLOR": "#3a3b34",   
    "TWITTER_TV_META_COLOR" : "#5a5b56", 
    
    // table view for pages 
    "PAGES_TV_BGCOLOR"    : "#f1f5e9",   
    "PAGES_TV_BGCOLOR_ALT": "#dee8ca",   
    "PAGES_TV_TITLE_COLOR": "#3a3b34", 
...
skin.RECENT_TV_GRADIENT = {
  type:'linear',
  colors:[ {color:'#f1f5e9',position:0.0},{color:'#dee8ca',position:1.0} ]
};
