var skin = {
    ...
    "POST_BAR_COLOR"      : "#a72a56", // example: #ff840a

    // about tab bar color and image
    // if use image, bar color and title should empty
    // if use text title, bar image should empty
    "ABOUT_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "ABOUT_BAR_COLOR"     : "#a72a56", // example: #ff840a

    "WEBVIEW_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "WEBVIEW_BAR_COLOR"   : "#a72a56", // example: #ff840a
    
    "TWITTER_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "TWITTER_BAR_COLOR"   : "#a72a56", // example: #ff840a
    
    "PAGES_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "PAGES_BAR_COLOR"     : "#a72a56", // example: #ff840a

    // table view for recent news
    "RECENT_TV_BGCOLOR"    : "#fff",   
    "RECENT_TV_BGCOLOR_ALT": "#fff",   
    "RECENT_TV_SEPARATOR_COLOR": "#e6e6e6",   
    "RECENT_TV_TITLE_COLOR": "#a72a56",   
    "RECENT_TV_META_COLOR" : "#404040",  

    // table view for categories 
    "CATEG_TV_BGCOLOR"    : "#fff",   
    "CATEG_TV_BGCOLOR_ALT": "#fff",   
    "CATEG_TV_SEPARATOR_COLOR": "#e6e6e6",   
    "CATEG_TV_TITLE_COLOR": "#a72a56",   
    "CATEG_TV_META_COLOR" : "#404040",  
    
    // table view for twitter 
    "TWITTER_TV_BGCOLOR"    : "#fff",   
    "TWITTER_TV_BGCOLOR_ALT": "#fff",   
    "TWITTER_TV_SEPARATOR_COLOR": "#e6e6e6",   
    "TWITTER_TV_TITLE_COLOR": "#a72a56",   
    "TWITTER_TV_META_COLOR" : "#404040", 
    
    // table view for pages 
    "PAGES_TV_BGCOLOR"    : "#fff",   
    "PAGES_TV_BGCOLOR_ALT": "#fff",   
    "PAGES_TV_TITLE_COLOR": "#a72a56", 
