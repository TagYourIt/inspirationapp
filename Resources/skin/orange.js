var skin = {
    ...
    "POST_BAR_COLOR"      : "#f9890b", // example: #ff840a

    // about tab bar color and image
    // if use image, bar color and title should empty
    // if use text title, bar image should empty
    "ABOUT_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "ABOUT_BAR_COLOR"     : "#f9890b", // example: #ff840a

    "WEBVIEW_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "WEBVIEW_BAR_COLOR"   : "#f9890b", // example: #ff840a
    
    "TWITTER_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "TWITTER_BAR_COLOR"   : "#f9890b", // example: #ff840a
    
    "PAGES_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "PAGES_BAR_COLOR"     : "#f9890b", // example: #ff840a

    // table view for recent news
    "RECENT_TV_BGCOLOR"    : "#ededed",   
    "RECENT_TV_BGCOLOR_ALT": "#f0f0f0",   
    "RECENT_TV_SEPARATOR_COLOR": "#e7e7e7",   
    "RECENT_TV_TITLE_COLOR": "#192028",   
    "RECENT_TV_META_COLOR" : "#f9890b",  

    // table view for categories 
    "CATEG_TV_BGCOLOR"    : "#ededed",   
    "CATEG_TV_BGCOLOR_ALT": "#f0f0f0",   
    "CATEG_TV_SEPARATOR_COLOR": "#e7e7e7",   
    "CATEG_TV_TITLE_COLOR": "#192028",   
    "CATEG_TV_META_COLOR" : "#f9890b",  
    
    // table view for twitter 
    "TWITTER_TV_BGCOLOR"    : "#ededed",   
    "TWITTER_TV_BGCOLOR_ALT": "#f0f0f0",   
    "TWITTER_TV_SEPARATOR_COLOR": "#e7e7e7",   
    "TWITTER_TV_TITLE_COLOR": "#192028",   
    "TWITTER_TV_META_COLOR" : "#f9890b", 
    
    // table view for pages 
    "PAGES_TV_BGCOLOR"    : "#ededed",   
    "PAGES_TV_BGCOLOR_ALT": "#f0f0f0",   
    "PAGES_TV_TITLE_COLOR": "#192028", 
