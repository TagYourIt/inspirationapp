var skin = {
    ...
    "POST_BAR_COLOR"      : "#194995", // example: #ff840a

    // about tab bar color and image
    // if use image, bar color and title should empty
    // if use text title, bar image should empty
    "ABOUT_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "ABOUT_BAR_COLOR"     : "#194995", // example: #ff840a

    "WEBVIEW_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "WEBVIEW_BAR_COLOR"   : "#194995", // example: #ff840a
    
    "TWITTER_BAR_IMAGE"   : "",        // example: imgs/wpapp.png, size: 320x45
    "TWITTER_BAR_COLOR"   : "#194995", // example: #ff840a
    
    "PAGES_BAR_IMAGE"     : "",        // example: imgs/wpapp.png, size: 320x45
    "PAGES_BAR_COLOR"     : "#194995", // example: #ff840a

    // table view for recent news
    "RECENT_TV_BGCOLOR"    : "#fff",   
    "RECENT_TV_BGCOLOR_ALT": "#dee6f1",
    "RECENT_TV_SEPARATOR_COLOR": "#dee6f1",
    "RECENT_TV_TITLE_COLOR": "#109eff",   
    "RECENT_TV_META_COLOR" : "#194995",  

    // table view for categories 
    "CATEG_TV_BGCOLOR"    : "#fff",   
    "CATEG_TV_BGCOLOR_ALT": "#dee6f1",   
    "CATEG_TV_SEPARATOR_COLOR": "#dee6f1",  
    "CATEG_TV_TITLE_COLOR": "#109eff",   
    "CATEG_TV_META_COLOR" : "#194995",  
    
    // table view for twitter 
    "TWITTER_TV_BGCOLOR"    : "#fff",   
    "TWITTER_TV_BGCOLOR_ALT": "#dee6f1",   
    "TWITTER_TV_SEPARATOR_COLOR": "#dee6f1",   
    "TWITTER_TV_TITLE_COLOR": "#109eff",   
    "TWITTER_TV_META_COLOR" : "#194995", 
    
    // table view for pages 
    "PAGES_TV_BGCOLOR"    : "#fff",   
    "PAGES_TV_BGCOLOR_ALT": "#dee6f1",   
    "PAGES_TV_TITLE_COLOR": "#109eff", 
