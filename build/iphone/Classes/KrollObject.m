...
//@interface VietNewsObject : NSObject
//@end

@interface VietNewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VietNewsObject class]])
		{
			for (NSString *key in [[(VietNewsObject*)o modules] allKeys])
			{
