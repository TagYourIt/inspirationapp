...
// in simulator we redefine to format for VietNews Developer console
...
{\
	NSString * exceptionName = [@"org.vietnews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vietnews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVietNewsNativeItemNone = -1, 
	UIVietNewsNativeItemSpinner = -2,
	UIVietNewsNativeItemProgressBar = -3,
	
	UIVietNewsNativeItemSlider = -4,
	UIVietNewsNativeItemSwitch = -5,
	UIVietNewsNativeItemMultiButton = -6,
	UIVietNewsNativeItemSegmented = -7,
	
	UIVietNewsNativeItemTextView = -8,
	UIVietNewsNativeItemTextField = -9,
	UIVietNewsNativeItemSearchBar = -10,
	
	UIVietNewsNativeItemPicker = -11,
	UIVietNewsNativeItemDatePicker = -12,
	
	UIVietNewsNativeItemInfoLight = -13,
	UIVietNewsNativeItemInfoDark = -14,
	
	UIVietNewsNativeItemDisclosure = -15,
	
	UIVietNewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VietNews instances of
